...
public:
    ...
    virtual long update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables) = 0;
    virtual long update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables) = 0;
private:
